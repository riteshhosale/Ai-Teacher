    ...
    <div className="min-h-screen bg-gray-50 text-gray-900 flex flex-col">
      ...
      <main className="flex-1">
        ...
        <section className="max-w-6xl mx-auto px-6 pt-16 pb-12 text-center">
          <span
            className="inline-block px-4 py-2 mb-5 rounded-full
          ...
          >
            {teamMembers.map((member, index) => (
              ...
              >
                ...
                {/* Name */}
                <h2 className="mt-5 text-xl font-bold">{member.name}</h2>
        ...
        <section className="bg-white border-y border-gray-200">
          <div className="max-w-4xl mx-auto px-6 py-12 text-center">
            ...
            <p className="mt-4 text-gray-500 leading-7">
              ...
              research, and project management to create a practical solution to
        ...
        <div className="max-w-6xl mx-auto px-6 py-8">
          ...
          >
            ...
            <div className="flex items-center gap-2">
              <div
                className="w-8 h-8 rounded-lg bg-indigo-600
